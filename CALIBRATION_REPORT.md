...
"calibrated" when every observable sits within one tolerance band (all `z ≤ 1`,
so `I ≤ 1`).
...
|-----------------------|---------:|---------------:|---------------------:|
| ad_ctr                |  0.0107  |  0.010 ± 0.008 | 0.09 |
| appeal_grant_rate     |  0.2000  |  0.250 ± 0.150 | 0.33 |
...
| posts_per_agent_day   |  0.5253  |  0.500 ± 0.350 | 0.07 |

**Implausibility I = 1.0** (cutoff 3.0); every metric within one tolerance band.
Deterministic replay of the calibrated run verifies bit-identically. Baseline
(uncalibrated BA) was `I = 1.667` with clustering at `z = 1.61`.
