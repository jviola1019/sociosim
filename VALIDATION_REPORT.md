...
First-order variance-based indices (LHS, n=24; output mean 0.8958, sd 0.2530).

| BehaviorParam | first-order index S1 |
|---|---|
| `p_post_given_active` | 1.000 |
| `engagement_base` | 0.988 |
| `p_share_given_engaged` | 0.853 |
| `impression_fatigue` | 0.807 |
| `p_flag_scale` | 0.724 |
